  ...
  return (
    <>
      ...
      <div className="w-[40rem] flex bg-white  p-3 rounded-full ">
        ...
        />
        <button
          className="bg-green-700 hover:bg-red-500 text-white p-3 rounded-full"
          onClick={handleAdd}
          >
          <svg
      ...
      {state.Tasks.length > 0 ? (
        <div className="flex w-[40rem] justify-between gap-7 mt-7 mb-2">
          <h3 className=" font-bold rounded-full text-black bg-white py-3 px-9">
            TASKS :
          </h3>
        ...
        <h3 className="mt-16 ">No Tasks has been added</h3>
      )}
